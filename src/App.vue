...
const showPopup = ref(true); // true, чтобы показывать попап при загрузке
...
onMounted(() => {
  ...
  }, 7000); // Попап закроется через 5 секунд
});
    ...
    <div v-if="showPopup" class="popup">
      <div class="popup-content">
        ...
        <div class="popup__img">
          <img src="./assets/img/Foto-cheif.png" alt="Photo">
        </div>
        <p>Я ваш синоптик на сегодня.</p>
        <button @click="showPopup = false" class="btn-76">Закрыть
          <span class="top"></span>
